...
<head>
    ...
    {{-- SEO Primary --}}
    <title>SI DARA — Sistem Deteksi Anemia Remaja</title>
    <meta name="description"
        content="SI DARA adalah aplikasi kesehatan digital untuk deteksi dini anemia pada remaja dan ibu hamil. Pantau hemoglobin, kunjungan ANC, data persalinan, dan tumbuh kembang bayi dalam satu platform.">
    <meta name="keywords"
        content="anemia remaja, deteksi anemia dini, sistem deteksi anemia, aplikasi kesehatan ibu hamil, ANC kunjungan antenatal, hemoglobin rendah, skrining anemia, kesehatan ibu, SI DARA">
    <meta name="author" content="SI DARA">
    ...
    <meta property="og:title" content="SI DARA — Sistem Deteksi Anemia Remaja">
    ...
    <meta property="og:site_name" content="SI DARA">

    {{-- Twitter Card --}}
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="SI DARA — Sistem Deteksi Anemia Remaja">
    ...
    <meta name="mobile-web-app-title" content="SI DARA">
