...
<div class="flex flex-col w-full h-full px-3 py-5">
    ...
    <nav class="flex-1 space-y-0.5 mt-2">
        ...
        <a href="{{ route($item['route']) }}" wire:navigate
           class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-colors
            ...
            @if($item['icon']==='home')
            <svg class="w-5 h-5 shrink-0" fill="{{ $active?'currentColor':'none' }}" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg>
            @elseif($item['icon']==='search')
            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.2-5.2m0 0A7.5 7.5 0 1 0 5.2 5.2a7.5 7.5 0 0 0 10.6 10.6z"/></svg>
            ...
            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15.182 15.182a4.5 4.5 0 0 1-6.364 0M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0z"/><path d="M9.75 9.75c0 .414-.168.75-.375.75S9 10.164 9 9.75s.168-.75.375-.75.375.336.375.75zm4.875 0c0 .414-.168.75-.375.75s-.375-.336-.375-.75.168-.75.375-.75.375.336.375.75z" fill="currentColor"/></svg>
    ...
    <div class="mt-auto pt-4 border-t border-pink-50">
        <a href="{{ route('profil') }}" wire:navigate
           class="flex items-center gap-3 p-2 rounded-xl hover:bg-pink-50 transition-colors">
            <div class="w-9 h-9 rounded-full shrink-0 bg-gradient-to-br from-pink-200 to-rose-300
