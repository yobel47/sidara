...
<div class="flex flex-col min-h-full">
    ...
    ══════════════════════════════════════ --}}
            <div class="bg-pink-50 px-4 pt-5 pb-8 lg:px-10 lg:pt-0 lg:pb-0">
                ...
                {{-- Info menu kehamilan terkunci --}}
                <div class="mt-3 bg-white rounded-2xl border border-gray-100 px-4 py-3 flex items-center gap-3">
                    ...
                    <p class="text-xs text-gray-400 leading-relaxed">
                        Menu Kehamilan, Persalinan, dan Data Bayi akan tersedia saat kamu memilih status <span
                            class="font-semibold text-rose-400">Hamil</span>.
                    </p>
                </div>
