...
<div class="flex flex-col min-h-screen lg:min-h-0 px-6 pt-12 pb-8 lg:px-8 lg:pt-10 lg:pb-10">
    ...
    <div class="flex items-start justify-between mb-6">
        ...
        <div class="w-28 h-28 -mt-2 -mr-2 shrink-0">
            <svg viewBox="0 0 140 160" fill="none" class="w-full h-full">
                ...
                <path d="M42 65 Q34 95 36 130 Q38 142 46 144" stroke="#1a0a00" stroke-width="12" fill="none"
                    stroke-linecap="round" />
                <path d="M98 65 Q106 95 104 130 Q102 142 94 144" stroke="#1a0a00" stroke-width="12" fill="none"
                    stroke-linecap="round" />
                ...
                <path d="M44 88 Q38 112 40 148 Q42 158 70 158 Q98 158 100 148 Q102 112 96 88 Q88 82 70 82 Q52 82 44 88Z"
                    fill="#ec4899" />
                <path d="M70 82 L62 100 L70 96 L78 100 Z" fill="white" opacity="0.9" />
                <path d="M44 95 Q28 88 22 75 Q18 66 24 62" stroke="#ec4899" stroke-width="12" fill="none"
                    stroke-linecap="round" />
                ...
                <path d="M96 95 Q112 105 114 118" stroke="#ec4899" stroke-width="12" fill="none"
                    stroke-linecap="round" />
    ...
    <form wire:submit="login" class="flex flex-col gap-4">
        ...
        <div>
            <div class="relative">
                ...
                <input wire:model="username" type="text" placeholder="Username atau Email" autocomplete="username"
        ...
        <div x-data="{ show: false }">
            <div class="relative">
                ...
                <input wire:model="password" :type="show ? 'text' : 'password'" placeholder="Password"
        ...
        <div class="flex justify-end -mt-1">
            <a href="{{ route('password.request') }}" wire:navigate
                class="text-xs text-gray-400 hover:text-rose-500 transition-colors font-semibold">
                Lupa password?
            </a>
        </div>

        @if(session('success'))
        <div class="bg-green-50 border border-green-200 rounded-xl px-4 py-3 -mt-1">
        ...
        <button type="submit" class="w-full py-4 rounded-2xl bg-rose-500 hover:bg-rose-600 active:scale-[0.98]
                     text-white font-extrabold text-sm tracking-widest uppercase
                    shadow-lg shadow-rose-200 transition-all mt-1
                    flex items-center justify-center gap-2
                    disabled:opacity-70 disabled:cursor-not-allowed" wire:loading.attr="disabled" wire:target="login">

            <svg wire:loading wire:target="login" class="w-4 h-4 animate-spin shrink-0" fill="none" viewBox="0 0 24 24">
    ...
    <p class="text-center text-sm text-gray-400 mt-8">
        Belum punya akun?
        <a href="{{ route('register') }}" wire:navigate class="font-bold text-rose-500 hover:text-rose-600 ml-1">
            Daftar di sini
        </a>
    </p>
