    ...
    public function editRecord(string $type, int $id): void
    {
        ...
        $this->recordForm = match ($type) {
            'pregnancy' => [
                ...
                'lila'                => $record->lila !== null ? (string) $record->lila : '',
                'tookIronSupplement'  => $record->took_iron_supplement === null ? '' : ($record->took_iron_supplement ? 'ya' : 'tidak'),
                'notes'               => $record->notes ?? '',
            ],
            'screening' => [
    ...
    public function saveRecord(): void
    {
        ...
        $rules = match ($type) {
            'pregnancy' => [
                ...
                'recordForm.hpht'                => 'nullable|date',
                'recordForm.hemoglobin'          => 'required|numeric|min:1|max:25',
                'recordForm.weight'              => 'required|numeric|min:20|max:200',
                'recordForm.height'              => 'nullable|numeric|min:100|max:250',
                'recordForm.systolic'            => 'required|integer|min:60|max:250',
                'recordForm.diastolic'           => 'required|integer|min:40|max:150',
                'recordForm.lila'                => 'required|numeric|min:10|max:50',
                'recordForm.tookIronSupplement'  => 'required|in:ya,tidak',
        ...
        $messages = match ($type) {
            'pregnancy' => [
                'recordForm.date_pregnancy.required'  => 'Tanggal kunjungan wajib diisi.',
                'recordForm.gestational_age.required' => 'Usia kehamilan wajib diisi.',
                'recordForm.gestational_age.min'      => 'Usia kehamilan minimal 1 minggu.',
                'recordForm.gestational_age.max'      => 'Usia kehamilan maksimal 42 minggu.',
                'recordForm.hemoglobin.required'      => 'Kadar Hb wajib diisi.',
                'recordForm.hemoglobin.min'           => 'Kadar Hb tidak valid.',
                'recordForm.hemoglobin.max'           => 'Kadar Hb tidak valid.',
                'recordForm.weight.required'          => 'Berat badan wajib diisi.',
                'recordForm.weight.min'               => 'Berat badan minimal 20 kg.',
                'recordForm.weight.max'               => 'Berat badan maksimal 200 kg.',
                'recordForm.height.min'               => 'Tinggi badan minimal 100 cm.',
                'recordForm.height.max'               => 'Tinggi badan maksimal 250 cm.',
                'recordForm.systolic.required'        => 'Tekanan darah (sistole) wajib diisi.',
                'recordForm.systolic.min'             => 'Tekanan darah (sistole) minimal 60 mmHg.',
                'recordForm.systolic.max'             => 'Tekanan darah (sistole) maksimal 250 mmHg.',
                'recordForm.diastolic.required'       => 'Tekanan darah (diastole) wajib diisi.',
                'recordForm.diastolic.min'            => 'Tekanan darah (diastole) minimal 40 mmHg.',
                'recordForm.diastolic.max'            => 'Tekanan darah (diastole) maksimal 150 mmHg.',
                'recordForm.lila.required'            => 'LILA wajib diisi.',
                'recordForm.lila.min'                 => 'LILA minimal 10 cm.',
                'recordForm.lila.max'                 => 'LILA maksimal 50 cm.',
                'recordForm.tookIronSupplement.required' => 'Konsumsi tablet tambah darah/MMS wajib dipilih.',
                'recordForm.notes.max'                => 'Catatan maksimal 500 karakter.',
            ],
            'screening' => [
                'recordForm.date_screening.required' => 'Tanggal skrining wajib diisi.',
                'recordForm.weight.required'         => 'Berat badan wajib diisi.',
                'recordForm.weight.min'              => 'Berat badan minimal 20 kg.',
                'recordForm.weight.max'              => 'Berat badan maksimal 200 kg.',
                'recordForm.height.required'         => 'Tinggi badan wajib diisi.',
                'recordForm.height.min'              => 'Tinggi badan minimal 100 cm.',
                'recordForm.height.max'              => 'Tinggi badan maksimal 250 cm.',
                'recordForm.hemoglobin.required'     => 'Kadar Hb wajib diisi.',
                'recordForm.hemoglobin.min'          => 'Kadar Hb tidak valid.',
                'recordForm.hemoglobin.max'          => 'Kadar Hb tidak valid.',
                'recordForm.complaint.required'      => 'Keluhan wajib diisi.',
                'recordForm.complaint.min'           => 'Keluhan terlalu singkat.',
            ],
            'childbirth' => [
                'recordForm.date_childbirth.required' => 'Tanggal persalinan wajib diisi.',
                'recordForm.gestational_age.required' => 'Usia kehamilan wajib diisi.',
                'recordForm.gestational_age.min'      => 'Usia kehamilan minimal 20 minggu.',
                'recordForm.gestational_age.max'      => 'Usia kehamilan maksimal 45 minggu.',
                'recordForm.place.required'           => 'Tempat persalinan wajib diisi.',
                'recordForm.type.required'            => 'Jenis persalinan wajib dipilih.',
                'recordForm.type.in'                  => 'Jenis persalinan tidak valid.',
                'recordForm.helper.required'          => 'Penolong persalinan wajib dipilih.',
                'recordForm.helper.in'                => 'Penolong persalinan tidak valid.',
                'recordForm.condition.required'       => 'Keadaan ibu wajib dipilih.',
                'recordForm.condition.in'             => 'Keadaan ibu tidak valid.',
                'recordForm.complication.max'         => 'Komplikasi maksimal 255 karakter.',
                'recordForm.notes.max'                => 'Catatan maksimal 300 karakter.',
            ],
            'baby' => [
                'recordForm.name.required'       => 'Nama bayi wajib diisi.',
                'recordForm.name.max'            => 'Nama bayi maksimal 100 karakter.',
                'recordForm.gender.required'     => 'Jenis kelamin wajib dipilih.',
                'recordForm.gender.in'           => 'Jenis kelamin tidak valid.',
                'recordForm.date_birth.required' => 'Tanggal lahir wajib diisi.',
                'recordForm.time_birth.date_format' => 'Format waktu lahir tidak valid (contoh: 14:30).',
                'recordForm.weight.required'     => 'Berat lahir wajib diisi.',
                'recordForm.weight.min'          => 'Berat lahir minimal 500 gram.',
                'recordForm.weight.max'          => 'Berat lahir maksimal 10.000 gram.',
                'recordForm.height.required'     => 'Panjang badan wajib diisi.',
                'recordForm.height.min'          => 'Panjang badan minimal 20 cm.',
                'recordForm.height.max'          => 'Panjang badan maksimal 70 cm.',
            ],
            default => [],
        };
        ...
        $data = match ($type) {
            'pregnancy' => [
                ...
                'hpht'                 => $this->recordForm['hpht'] ?: null,
                'hemoglobin'           => (float) $this->recordForm['hemoglobin'],
                'weight'               => (float) $this->recordForm['weight'],
                'height'               => $this->recordForm['height'] !== '' ? (float) $this->recordForm['height'] : null,
                'systolic'             => (int) $this->recordForm['systolic'],
                'diastolic'            => (int) $this->recordForm['diastolic'],
                'lila'                 => (float) $this->recordForm['lila'],
                'took_iron_supplement' => $this->recordForm['tookIronSupplement'] === 'ya',
